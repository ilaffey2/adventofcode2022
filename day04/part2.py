...
for line in lines:
    ...
    if (first_elf_upper_bound in range(second_elf_lower_bound, second_elf_upper_bound+1) or 
    first_elf_lower_bound in range(second_elf_lower_bound, second_elf_upper_bound+1)):
        total_count += 1
    elif (second_elf_upper_bound in range(first_elf_lower_bound, first_elf_upper_bound+1) or 
